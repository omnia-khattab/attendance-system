...
<div class="cont">
    <div class="form">
        <form action="../controller/checkAttendanceHandel.php" method="POST">
        ...
        <div class="mb-3">
            <label for="exampleInputtext1" class="form-label">From</label>
        ...
        <button type="submit" class="btn btn-primary" name="btn_submit">check Attendance</button>
        </form>
    </div>
</div>
